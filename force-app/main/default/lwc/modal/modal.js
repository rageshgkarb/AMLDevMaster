...
_wdSet = 'slds-modal__container  slds-modal__container-wide';
@api
get widthSetting()
{
return this._wdSet;
}
set widthSetting(value)
{
if (value.toLowerCase() == 'medium')
this._wdSet = 'slds-modal__container';
else
this._wdSet = 'slds-modal__container slds-modal__container-wide';
}
